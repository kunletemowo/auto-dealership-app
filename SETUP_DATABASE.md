# Database Setup - Copy This SQL

If you're having trouble opening the `.sql` file, copy and paste this SQL directly into your Supabase SQL Editor.

## Step 1: Copy and Run This SQL Script

Go to your Supabase Dashboard → SQL Editor → New Query, then paste this:
...
-- 3. Set it to Public
-- 4. Run the storage policies SQL (see STEP 2 below)
-- =====================================================
```
